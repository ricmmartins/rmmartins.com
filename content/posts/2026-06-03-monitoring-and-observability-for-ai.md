...
Seventh post in the series. In the [previous one](/mlops-model-lifecycle-for-infra-engineers/), we put models into production with CI/CD pipelines. Now: how do you know they're actually healthy?
