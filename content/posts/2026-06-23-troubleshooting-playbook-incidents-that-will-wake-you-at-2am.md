...
Twelfth post in the series. In the [previous one](/azure-openai-in-production-tokens-throughput-and-high-availability/), we operated Azure OpenAI with HA and correct retry patterns. Now: when things break (and they will break).
