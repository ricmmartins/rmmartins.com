...
Thirteenth post in the series. In the [previous one](/troubleshooting-playbook-incidents-that-will-wake-you-at-2am/), we diagnosed the incidents that wake you up at 2 AM. Now something different: how to use AI to improve the infrastructure work itself.
